...
pub fn hit_sphere_ray(sphere: Sphere, ray: Ray, t: i32) -> (bool, f64){
    ...
    let t0 = (b as f64) - (d as f64).sqrt();
    let t1 = (b as f64) + (d as f64).sqrt();
    if (t1 > 0.1) && (t0 < t as f64) {
        return (true, t0)
    }
    if (t1 > 0.1) && (t1 < t as f64) {
        return (true, t1)
    }
    (false, -1.0)
}